...
local url  = https.request('https://api.telegram.org/bot940044754:AAGY1zvFOrPoYdIUnAgHtHHpI-quJP5QTQM/getchatmember?chat_id=@legandb0t&user_id='..msg.sender_user_id_)
if res ~= 200 then
end
...
bd = '⋆ ⇽العضو ['..USERNAME..'](tg://user?id='..msg.sender_user_id_..') \n⋆⇽لأستخدام البوت عليك الاشتراك ب قناة السورس @legandb0t'
...
local inline = {{{text="⚜⇽قناه السـورس ضـغـط هنا ",url="t.me/UU_IV1"}}}
send_key(msg.sender_user_id_,'  [⚜⇽قناة سورس : ليجاند](t.me/UU_IV1)',nil,inline,msg.id_)
return false
end
...
return [[
⋆  ━━━  𝖑𝖊𝖌𝖆𝖓𝖉  ━━━ ⋆
 [- The Source Developer ](https://t.me/UU_Le) 💌 .
 [- The Bot channel](https://t.me/UU_Le1) 💌 .
⋆  ━━━  𝖑𝖊𝖌𝖆𝖓𝖉  ━━━ ⋆
]]
end
...
redis:setex(max..'2DaySleep',172800,'legandb0t')
