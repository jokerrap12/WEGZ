...
local Get_info ="↯𖣐 أهلا عزيزي تم مسح جميع معلوماتك "
return sendMsg(msg.chat_id_,msg.id_,Get_info)    
end,nil)
return false
end
...
if mtwren == 0 then  return "↯𖣐 عذرا لا يوجد مطورين في البوت ." end
...
sendMsg(msg.chat_id_,msg.id_,"↯𖣐 عذرا النسخه الاحتياطيه هذا ليست للبوت » ["..Bot_User.."]  \n")
end
else 
sendMsg(msg.chat_id_,msg.id_,'↯𖣐 عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ويجز يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
sendMsg(msg.chat_id_,msg.id_,'↯𖣐 عذرا الملف ليس بصيغه Json !?\n')
end 
else
sendMsg(msg.chat_id_,msg.id_,'↯𖣐 عذرا هذا ليس ملف النسحه الاحتياطيه للمجموعات\n')
end 
end,nil)
else 
...
𖣐3- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائيا .
...
𖣐1- اضف البوت الى المجموعه
𖣐2- ارفع البوت مشرف في المجموعه
𖣐③- ارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القررب تلقائيا .
