--[[
الالعاب ل سورس ويجز
تم تعديل الملف واضافه الالعاب من قبل أحمد (@ahmedyad200)
--]]
...
name = string.gsub(name," دحوو6م ","  هل يعجبك سورس سليندر ؟  ؟ ")
...
name = string.gsub(name," دحوو14م "," اي رايك في سورس سليندر ؟ ")
